...
async def get_quote(ticker: str, current_user: Optional[int] = Depends(get_current_user)):
...
async def get_fundamentals(ticker: str, current_user: Optional[int] = Depends(get_current_user)):
